...
public class ShowAudioListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		AudioList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				   ...
				   intent.setDataAndType(MediaUri.get(position), "audio");   
		...
		for( int i = 0; i < Count; ++i ) 
		{
			...
			OneItem.put("Img", R.drawable.record_icon);
			OneItem.put("Title", "“Ù∆µ»’÷æ"+Integer.toString(i+1));
			Items.add(OneItem);  
		}
