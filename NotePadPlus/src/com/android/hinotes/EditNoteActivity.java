	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ChgTagClrBtn.setOnClickListener(new OnClickListener(){
    		public void onClick(View v){
				...
				intent.setClass(EditNoteActivity.this, SetItemClrActivity.class);
	 ...
	 public void onBackPressed(){
    	 ...
    	 EditOneNote.NoteBody = NoteBodyCtrl.getText().toString();
         // Check title
	...
	protected Dialog onCreateDialog(int id) {
		switch (id) {
		   ...
		   case ProjectConst.ShareBy_Dlg:
			    return HelperFunctions.BuildTextPlainShareByDlg(this, R.string.shareby_title, EditOneNote.NoteTitle, EditOneNote.NoteBody);
		}
		return null;
	}
