        ...
        DialogInterface.OnClickListener listener =   
            new DialogInterface.OnClickListener() {  
                ...
                public void onClick(DialogInterface dialogInterface, int which) {
        	                ...
        	                remoteViews.setImageViewBitmap(android.R.id.background, HelperFunctions.GetAlpha1x1Bg(NotePad1X1WidgetHelper.this, R.drawable.bg_note_1x1, 75, 75, ClrId));
                		    ...
                		    if( IsLocked ) {
                				...
                				if( Type == OneNote.ListNote )
                					ActivityIntent = new Intent(NotePad1X1WidgetHelper.this, EditCheckListNoteActivity.class);
